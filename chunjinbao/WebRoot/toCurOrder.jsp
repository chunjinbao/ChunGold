	...
	<section class="warp">
        <div class="regularly_buy">            
            ...
            <div class="regularly_buy_con">
            	...
            	<form id="buyCurrentForm0" name="buyCurrentForm" action="<s:url action='curOrder_insertOrder' />?productId=<%=productId%>" method="post">
                	<ul>
                    	<li>
                        	<span>购买金价</span>
                        ...
                        <li><span>金额</span><input name="curOrder.tradeAmount" type="number" placeholder="输入购买金额" id="count1" onkeyup="check_input('count1',2);"></li>
                ...
                <form id="buyCurrentForm1" name="buyCurrentForm" action="<s:url action='curOrder_insertOrder' />?productId=<%=productId%>" method="post">
                	<ul>
                    	<li>
                        	<span>购买金价</span>
                            <input name="" type="text" placeholder="实时金价" value="263.3 元/克" class="price" readonly="readonly">
                         ...
                         <li><span>克重</span><input name="curOrder.tradeNum" type="number" placeholder="输入购买克重" id="count2" onkeyup="check_input('count2',4);"></li>
