	...
	<section class="warp">    
        ...
        <ul>
			...
			<li class="home_group_2">
                ...
                <div><a href="wxMainController.do?price"><b><%= GetGoldPrice.getRequest1()  %></b><i>元/克</i></a></div><a href="wxMainController.do?products"><img src="plug-in/wechat/images/pic13.png" alt="" class="img_02" /></a>
			...
			<p style="font-size: 15px;">当前登录用户：<%=session.getAttribute("curUsrName").toString()%></p>
			</div>
			<br><br><br><br>
        </ul>
    <nav>
...
<nav>
	<ul class="clearfix">
    	<li><a href="wxMainController.do?index" class="active"><i class="n1"></i>首页</a></li>
